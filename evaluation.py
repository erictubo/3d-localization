...
def get_reference_transformation(path_to_images: Path, name: str = 'reference_transformation.txt') -> np.ndarray:
    """
    Get reference transformation from text file.
    """
    T_ref = np.loadtxt(path_to_images / name)
    assert T_ref.shape == (4,4), T_ref.shape
...
def combine_images():
    path_to_renders = Path('/Users/eric/Library/Mobile Documents/com~apple~CloudDocs/Blender/renders/notre dame')
...
if __name__ == '__main__':
    ...
    # CAD in SFM frame
    # T_sfm_cad = get_reference_transformation(path_to_images)
    ...
    # TODO: get translation matrix from text file (for each model)
    ...
    combine_images()
        ...
        # TODO: separate script into tasks
        # 1. main
        # 2. evaluation
        # 3. ...
        ...
        # TODO: evaluate for mutiple models
